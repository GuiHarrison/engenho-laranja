<?php /* Template Name: Produtos */ get_header(); ?>
	...
	<main role="main">
		...
		<section>
			...
			<div class="escolhaProdutos">
				<ul class="trabalho">
					<li><a href="<?php echo home_url( '/tecnologia' ); ?>">Tecnologia</a></li>
					<li><a href="<?php echo home_url( '/produtos' ); ?>">Produtos</a></li>
					<li><a href="<?php echo home_url( '/premios-e-certificacoes' ); ?>">Prêmios e Certificações</a></li>
				</ul>
				<?php if (has_post_thumbnail()) { ?> <div class="imagemProduto"> <?php the_post_thumbnail( 'bannerProduto' ); ?></div><?php }; ?>
			</div>
